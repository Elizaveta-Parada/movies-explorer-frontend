                ...
                <form className="profile__form" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className='profile__button'>
                        ...
                        {edit ?
                            ...
                            :
                            <><button className='profile__button-submit'
                                type="submit" onClick={handleEditProfile}>Редактировать</button>
                                <Link className='profile__link' onClick={signOut}>Выйти из аккаунта</Link>
                            </>
                        }
                    </div>
                </form>
